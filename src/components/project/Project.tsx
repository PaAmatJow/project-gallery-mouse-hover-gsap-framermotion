...
const Project = ({ index, title, setModal }: ProjectProps) => {
	return (
		<div
			className='flex items-center justify-between w-full px-[100px] py-[50px] border-t border-[#C9C9C9] cursor-pointer transition-all duration-200 last-of-type:border-b hover:opacity-50 group'
			onMouseEnter={() => {
